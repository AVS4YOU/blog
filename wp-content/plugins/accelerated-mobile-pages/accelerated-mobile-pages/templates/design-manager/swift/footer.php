...
<footer>
		<div class="footer-grid-container" id="footerHidden">
			<div class="footer-links-box">
				<h4><?php pll_e('Windows software') ?></h4>
				<div class="footer-links-wrapper" id="footerHidden1">
			...
			<div class="footer-links-box">
				...
				<div class="footer-links-wrapper" id="footerHidden2">
			...
			<div class="footer-links-box">
				<h4><?php pll_e('Help center') ?></h4>
				<div class="footer-links-wrapper" id="footerHidden3">
			...
			<div class="footer-links-box">
				<h4 class="h4footer"><?php pll_e('Company') ?></h4>
				<div class="footer-links-wrapper" id="footerHidden4">
			...
			<div class="footer-links-box last">
				<div class="footerLogo">
				<a href="https://www.avs4you.com<?php pll_e('/') ?>"></a>
				</div>
				<div>
					<p><?php pll_e('Follow Us:') ?></p>
					<a class="footerSocial fb" href="https://www.facebook.com/avs4you"></a>
					<a class="footerSocial yt" href="https://www.youtube.com/user/avs4you"></a>
					<a class="footerSocial tw" href="https://www.twitter.com/avs4you"></a>
					<a class="footerSocial pin" href="https://pinterest.com/avs4you/"></a>
				</div>
			</div>
		</div>
