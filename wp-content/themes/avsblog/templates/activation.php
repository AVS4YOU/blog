...
<?php 
    ...
    <?php function renderResult($email, $secureCode, $date) {
        ...
        if(!empty($count) && isset($count)){ ?>
            <div class="activationWrapper">
                <div class="contentBox">
                    <h1>You are already subscribed. Please check your spam folder.</h1>
                    <p>Enjoy reading AVS4YOU blog!</p>
                    <a href="<?php echo site_url() ?>">Explore blog</a>
                </div>
        ...
        elseif ($checkCode && addEmail($email, $date)) { ?>
            ...
            <div class="activationWrapper">
                <div class="contentBox">
                    <h1><b>Thank you</b> for signing up for AVS4YOU newsletter!</h1>
                    <p>Check your inbox for the first email and stay updated from now on!</p>
                    <a href="<?php echo site_url() ?>">Explore blog</a>
                </div>
                <div class="activationImage"></div>
            </div>
